...
namespace DWorkLog
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            hook.RegisterHotKey(DWorkLog.ModifierKeys.Control | DWorkLog.ModifierKeys.Shift,
                                Keys.Insert);
            hook.RegisterHotKey(DWorkLog.ModifierKeys.Control | DWorkLog.ModifierKeys.Shift,
                                Keys.Home);
            hook.RegisterHotKey(DWorkLog.ModifierKeys.Control | DWorkLog.ModifierKeys.Shift,
        ...
        {
            if ((e.Modifier & (DWorkLog.ModifierKeys.Control | DWorkLog.ModifierKeys.Shift))
                == (DWorkLog.ModifierKeys.Control | DWorkLog.ModifierKeys.Shift))
            {
            ...
            if ((e.Modifier & DWorkLog.ModifierKeys.Control) == DWorkLog.ModifierKeys.Control)
            {
